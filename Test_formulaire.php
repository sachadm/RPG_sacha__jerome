...
<body>
    <div class="creacharac">
        <div class="crea_perso">
            <!-- le form n'est plus relié c'esst une page test -->
            <form action="" method="post" enctype="multipart/form-data"
                ...
                <div class="PV line">
                    <div class="info_stat_crea"><strong class="stat_name_crea">PV</strong> : Ceci représente votre
                        maximum de point de vie</div>
                    <div class=incr>
                ...
                <div class="Mana line">
                    <div class="info_stat_crea"><strong class="stat_name_crea">Mana</strong> : Ceci représente votre
                        puissance magique</div>
                    <div class=incr>
                ...
                <div class="ATK line">
                    <div class="info_stat_crea"><strong class="stat_name_crea">ATK</strong> : Ceci représente la force
                        de vos attaques physique</div>
                    <div class=incr>
                ...
                <div class="Init line">
                    <div class="info_stat_crea"><strong class="stat_name_crea">Initiative</strong> : Désigne la vitesse
                        de réaction des personnages dans un moment d'action </div>
                    <div class=incr>
                ...
                <div class="DEF line">
                    <div class="info_stat_crea"><strong class="stat_name_crea">Défense</strong> : Ceci représente votre
                        capacité a vous défendre</div>
                    <div class=incr>
    ...
    <!-- Tableau selection de personnages -->
    <div class="container_charaSelection">
    ...
    <!-- Fin tableau selection de personnages -->
</body>
